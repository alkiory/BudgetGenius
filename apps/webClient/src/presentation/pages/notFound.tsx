        ...
        <div className="max-w-md">
          <div className="mb-6 flex justify-center">
            ...
            <div className="relative rounded-full bg-purple-100 p-6 dark:bg-purple-900">
              <span className="text-7xl font-bold text-purple-600 dark:text-purple-400">404</span>
            </div>
          </div>
          <h1 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl dark:text-neutral">{t('errors.notFound')}</h1>
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            ...
            {user ? (
              <Button variant="outline" size="lg">
                <Link to={RoutePaths.App + "/" + RoutePaths.Dashboard}>{t('sidebar.dashboard')}</Link>
              </Button>
            ) : (
              <Button variant="outline" size="lg">
                <Link to={RoutePaths.Auth + "/" + RoutePaths.Login}>{t('auth.signIn')}</Link>
              </Button>
            )}
          </div>
        </div>
