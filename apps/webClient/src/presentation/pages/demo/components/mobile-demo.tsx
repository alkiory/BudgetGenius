      ...
      <div className="rounded-lg border bg-card p-6 shadow-xl">
        ...
        <div className="mx-auto w-[320px] rounded-[32px] border-8 border-slate-800 bg-background p-2 shadow-xl">
          ...
          <div className="h-[500px] overflow-y-auto p-3">
            ...
            <div className="mb-4">
              <div className="mb-2 flex items-center justify-between">
                <h3 className="font-medium">{t('dashboard.recentTransactions')}</h3>
                <button className="text-xs text-purple-600 dark:text-purple-400">{t('common.viewAll')}</button>
              </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400">Apr 12</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400">Apr 10</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400">Apr 9</p>
                      </div>
                    </div>
                    <span className="text-sm font-medium text-red-500 dark:text-red-400">-$4.50</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="space-y-2">
                <div className="rounded-lg border bg-card p-2 shadow-sm">
                  ...
                  <p className="mt-1 text-xs text-right text-slate-500 dark:text-slate-400">$4,000/$5,000</p>
                </div>
                <div className="rounded-lg border bg-card p-2 shadow-sm">
                  <div className="flex items-center justify-between mb-1">
                  ...
                  <p className="mt-1 text-xs text-right text-slate-500 dark:text-slate-400">$9,000/$20,000</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 grid grid-cols-2 gap-4">
          <div className="rounded-lg border p-4 shadow-sm bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-100">
            ...
            <h3 className="mb-1 text-base font-semibold">{t('demo.onTheGoAccess')}</h3>
            <p className="text-xs text-muted-foreground">{t('demo.onTheGoAccessDesc')}</p>
          </div>
          <div className="rounded-lg border p-4 shadow-sm bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-100">
            <div className="mb-2 inline-flex h-8 w-8 items-center justify-center rounded-lg bg-purple-100 dark:bg-purple-900">
              <Plus className="h-4 w-4 text-purple-600 dark:text-purple-400" />
            </div>
            <h3 className="mb-1 text-base font-semibold">{t('demo.quickAdd')}</h3>
