      ...
      <section className="bg-gradient-to-b from-purple-500 to-cyan-50 py-20 dark:from-purple-900 dark:to-slate-900">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button
              size="lg"
              className="bg-purple-700 hover:bg-purple-800 hover:scale-110 transition-all"
            >
            ...
            <Button
              variant="outline"
              size="lg"
              className="bg-white hover:scale-110 transition-all dark:bg-transparent dark:text-white dark:border-white"
            >
          ...
          {/* App Preview */}
          <div className="mt-16 overflow-hidden rounded-lg border bg-white p-2 shadow-xl dark:bg-slate-800 dark:border-slate-700">
            <img
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card className="rounded-lg border bg-slate-50 p-6 hover:scale-105 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-100">
              ...
              <CardTitle className="mb-2 text-xl font-semibold">
                {t("landing.budgetPlanning")}
              </CardTitle>
              <CardDescription>
                {t("landing.budgetPlanningDesc")}
              </CardDescription>
            </Card>
            <Card className="rounded-lg border bg-slate-50 p-6 hover:scale-105 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-100">
              <CardHeader className="mb-4 inline-grid h-12 w-12 items-center justify-center rounded-lg bg-purple-100 dark:bg-purple-900">
              ...
              <CardTitle className="mb-2 text-xl font-semibold">
                {t("landing.financialGoals")}
              </CardTitle>
              <CardDescription>
                {t("landing.financialGoalsDesc")}
              </CardDescription>
            </Card>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-lg bg-white p-6 drop-shadow-lg dark:bg-slate-800 hover:bg-slate-200">
              ...
              <p className="mb-4 text-slate-500">{t("landing.testimonial1")}</p>
            ...
            <div className="rounded-lg bg-white p-6 drop-shadow-lg dark:bg-slate-800 hover:bg-slate-200">
              ...
              <p className="mb-4 text-slate-500">{t("landing.testimonial2")}</p>
              <div className="flex items-center gap-2">
                <img
            ...
            <div className="rounded-lg bg-white p-6 drop-shadow-lg dark:bg-slate-800 hover:bg-slate-200">
              ...
              <p className="mb-4 text-slate-500">{t("landing.testimonial3")}</p>
              <div className="flex items-center gap-2">
                <img
