...
export function IncomeByCategory({ incomeByCategory }: IncomeByCategoryProps) {
  ...
  const convertedSortedData: ConvertedChartData[] = useMemo(() => {
    const sortedOriginalData = [...incomeByCategory].sort(
  ...
  const totalConvertedIncome = useMemo(() => {
    const totalOriginalAmount = incomeByCategory.reduce(
            ...
            >
              ...
              <XAxis
                ...
                tickFormatter={(value: number) =>
                  totalConvertedIncome.symbol +
                  value.toLocaleString(formattedLocale)
                }
              />
              <YAxis
                dataKey="category"
