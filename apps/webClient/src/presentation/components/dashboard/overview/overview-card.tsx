...
export function OverviewCard({ balance, income, expenses, period }: OverviewCardProps) {
  ...
  return (
    <div className="rounded-lg bg-white p-6 shadow-sm dark:bg-slate-800">
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-sm text-slate-500 dark:text-slate-400">{periodDate.toDateString()}</span>
      </div>
